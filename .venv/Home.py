...
with col1:
    st.image(r"photos\image2.jpg", width=600)
...
with col7:
    ...
    st.image(r"photos\xy.png", width=300)
    ...
    st.header("To-Do App")
    st.image(r"photos\1.png", width=300)
    ...
    st.image(r"photos\9.png", width=300)
...
with col8:
    ...
    st.image(r"photos\market_basket_analysis.jpg", width=280)
    ...
    st.image(r"photos\15.png", width=300)
